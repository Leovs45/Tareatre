...
<title>Gimnasio | Inscripciones</title>
</head>
<body>
...
<h1>Inscripciones</h1>
	<form action="GestionInscripcion" method="post">
		...
		<div class="form-group">
			<label for="exampleInputEmail1">Cédula</label> <input type="text"
				name="cedSocio" class="form-control" id="exampleInputEmail1"
		...
		<button type="button" class="btn btn-primary"
			onclick="procesar('agregar')">Agregar Inscripcion</button>
		<button type="button" class="btn btn-primary"
			onclick="procesar('eliminar')">Eliminar Inscripcion</button>
	</form>
