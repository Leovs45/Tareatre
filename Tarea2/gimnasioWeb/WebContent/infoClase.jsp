<%@page import="datatypes.DtSpinning"%>
...
<body>
	...
	<%
		...
		int idClase = (int) request.getAttribute("idClase");
		if (mostrar.equals("socios")) {
			ArrayList<DtSocio> socios = (ArrayList<DtSocio>) request.getAttribute("socios");
	%>
	<h1>
		Socios inscriptos en la clase de ID
		<%=idClase%></h1>
