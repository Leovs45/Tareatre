	   ...
	   <% } else { 
          ...
          <div class="card m-2" style="width: 250px;">
			<div class="card-body" style="display: flex; flex-direction: column; justify-content: space-between;">
				...
				<p class="card-text">
					<span style="font-weight: 600;">Actividad Deportiva:</span> <%= clase.getNombreActividad() %>
					<br>
			   ...
			   <form
					...
					method="post"
			   >
			   		<input type="hidden" id="clase" name="unaActividad" value="<%= clase.getNombreActividad() %>">
